...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <p className="text-gray-600 mb-8">Here's your DupeDetect AI - Automated product similarity monitoring for brands overview.</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
          <a href="/dashboard/products" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
            <h3 className="font-medium">Product Watchlist</h3>
            <p className="text-sm text-gray-500">Manage products under IP monitoring</p>
          </a>
          <a href="/dashboard/alerts" className="block p-4 border rounded-lg hover:bg-blue-50 transition">
