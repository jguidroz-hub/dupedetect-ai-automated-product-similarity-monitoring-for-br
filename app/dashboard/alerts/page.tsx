...
export default function AlertsPage() {
  const [items, setItems] = useState<AlertsItem[]>([]);
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold">Dupe Alerts</h1>
        <button
      ...
      <p className="text-gray-600 mb-6">Potential IP infringement notifications</p>
