  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">DupeDetect AI - Automated product similarity monitoring for brands</h1>
        <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">Value Proposition: Helps e-commerce brands and designers protect their intellectual property by automatically identifying and alerting them to visually and descriptively similar "dupe" products sold across online marketplaces, preventing revenue loss and brand dilution (Signal 3).
...
Promotion Type: automatic</p>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-gray-600 mb-6">Join thousands of small businesses who trust DupeDetect AI - Automated product similarity monitoring for brands.</p>
      ...
      <footer className="border-t py-8">
        <div className="max-w-4xl mx-auto px-6 flex justify-between text-sm text-gray-500">
          <p>© {new Date().getFullYear()} DupeDetect AI - Automated product similarity monitoring for brands. All rights reserved.</p>
