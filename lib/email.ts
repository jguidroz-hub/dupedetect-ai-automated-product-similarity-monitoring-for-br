...
const FROM = process.env.EMAIL_FROM || 'DupeDetect AI - Automated product similarity monitoring for brands <noreply@example.com>';
const APP_NAME = 'DupeDetect AI - Automated product similarity monitoring for brands';
